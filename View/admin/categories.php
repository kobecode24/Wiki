        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            ...
            <div id="layoutSidenav_content">
                <div class="container my-4">
                    ...
                    <h1>Categories</h1>
                    <p>List of all categories in the Wiki website</p>
                    <table class="table">
                        <thead>
                        <tr>
                            <th scope="col">#</th>
                        ...
                        <?php foreach ($categories as $category): ?>
                            <tr>
                                <th><?php echo htmlspecialchars($category["id"]); ?></th>
                                <td><?php echo htmlspecialchars($category["name"]); ?></td>
                                <td>
                                    <a href="edit_category.php?id=<?php echo $category["id"]?>" class="btn btn-outline-primary btn-sm">Edit</a>
                                    <form action="../../app/Controller/CategoryController.php" method="post" style="display: inline-block;">
